---
title: "Scout MCP"
description: "Connect Scout to model orchestrators via the Model Context Protocol."
icon: "sparkles"
---

<Warning>
  **Coming Soon** - MCP support is planned after the CLI launch. We want to make it easy for your AI agents to collaborate with Scout.
</Warning>
