...
Configure vision tools to use either Anthropic Computer Use or Nova Act backends. Watch your agent in action with tool call visualization showing icons and descriptions for every action—clicks, typing, navigation, and more.
